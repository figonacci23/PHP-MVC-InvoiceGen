                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Eliminar Artigo</h3></div>
                                    <div class="card-body">
                                        <div class="small mb-3 text-muted"></div>
                                        <?php echo                               
                                        "<form action=\"/ex1final/EliminarArtigoAction\" method=\"post\">
                                        <h4>Tem a certeza que quer eliminar o artigo \"$nome\" ?</h4>
