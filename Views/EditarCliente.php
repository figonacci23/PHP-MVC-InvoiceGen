...
?>
                ...
                <main>
                <link href="/ex1final/assets/css/styles.css" rel="stylesheet" />
                    <div class="container">
                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php echo
                                        "<form action=\"/ex1final/EditarClienteAction\" method=\"post\">
                                            ...
                                            <div class=\"form-floating mb-3\">
                                                <input class=\"form-control\" value=\"$morada\"  name=\"morada\" type=\"name\" placeholder=\"asd321\" />
